    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="h-full flex flex-col bg-transparent">
          ...
          {/* Top Safe Header (fixed spacer) */}
<div className="absolute top-12 left-0 right-0 h-12 z-40 bg-white border-b border-white/30" />

          {/* Scrollable content */}
          <div className="flex-1 pt-12 overflow-y-auto bg-transparent hide-scrollbar">
            {currentScreen === 'home' && (
              <HomeScreen
